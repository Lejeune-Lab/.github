...
* [Open Access Mechanics Datasets curated from the broader mechanics community](https://elejeune11.github.io/) - please contact elejeune@bu.edu if you have datasets that you think we should add!
...
* [Closer Look Journal Club -- 59 speakers to date!](https://www.youtube.com/@closerlookanopenjournalclu8797/videos)
* [Presentation on Open Science at SB3C 2023](https://docs.google.com/presentation/d/1b_66DyxAr8RpOyXZNmsVInxNaDKuKxzW5TafgdAqp6w/edit?usp=sharing)
* [BU Mechanical Engineering PhD program](https://www.bu.edu/eng/academics/explore-degree-programs/phd-in-meche/)
* [Introduction to Computational Research with the Lejeune Lab at BU](https://github.com/Lejeune-Lab/BU_computational_research_intro)
...
| **Paper(s):** [Journal Link](https://joss.theoj.org/papers/10.21105/joss.05727.pdf) |
...
* Mohammadzadeh, S., Hamdi, E., Shor, J., & Lejeune, E. (2025). FEM-Bench: A Structured Scientific Reasoning Benchmark for Evaluating Code-Generating LLMs. arXiv preprint arXiv:2512.20732. \[ [paper](https://arxiv.org/abs/2512.20732) | [code](https://github.com/elejeune11/FEM-bench) \]
* Prachaseree, P., & Lejeune, E. (2025). Towards understanding structure-function relationships in random fiber networks. Journal of the Mechanics and Physics of Solids, 106221. \[ [paper](https://www.sciencedirect.com/science/article/pii/S0022509625001978) | [code](https://github.com/pprachas/struc_func_fiber_network) \]
* Prachaseree, P., Mohammadzadeh, S., Dortdivanlioglu, B., & Lejeune, E. (2024). FEniCS-arclength: A numerical continuation package in FEniCS for nonlinear problems in solid mechanics. Journal of Open Source Software, 9(94), 5727. \[ [paper](https://joss.theoj.org/papers/10.21105/joss.05727.pdf) | [code](https://github.com/pprachas/fenics_arclength) \]
...
* Prachaseree, P., & Lejeune, E. (2022). Learning Mechanically Driven Emergent Behavior with Message Passing Neural Networks. Computers & Structures, 270, 106825. \[ [paper](https://arxiv.org/abs/2202.01380) | [code](https://github.com/Lejeune-Lab/ABC_dataset) | [data](https://open.bu.edu/handle/2144/43730) \]
* Kobeissi, H., Mohammadzadeh, S., & Lejeune, E. (2022). Enhancing Mechanical Metamodels with a Generative Model-Based Augmented Training Dataset. Journal of Biomechanical Engineering. \[ [paper](https://arxiv.org/abs/2203.04183) | [code](https://github.com/Lejeune-Lab/ch-pattern-synthesis) | [data](https://open.bu.edu/handle/2144/43971) \]
* Mohammadzadeh, S., & Lejeune, E. (2021). Predicting mechanically driven full-field Quantities of Interest with deep learning-based metamodels. Extreme Mechanics Letters, 101566. \[ [paper](https://www.sciencedirect.com/science/article/pii/S2352431621002303) | [code](https://github.com/Lejeune-Lab/MultiRes-WNet) | [data-light](https://open.bu.edu/handle/2144/42757) | [data-extended](https://datadryad.org/stash/dataset/doi:10.5061/dryad.rv15dv486) \]
* Zhao B., Zhang K., Chen C.S., & Lejeune E. (2021) Sarc-Graph: Automated segmentation, tracking, and analysis of sarcomeres in hiPSC-derived cardiomyocytes. PLoS Comput Biol 17(10): e1009443. \[ [paper](https://doi.org/10.1371/journal.pcbi.1009443) | [code](https://github.com/Lejeune-Lab/Sarc-Graph) \]
* Lejeune, E., & Zhao, B. (2021). Exploring the potential of transfer learning for metamodels of heterogeneous material deformation. Journal of the Mechanical Behavior of Biomedical Materials, 104276. \[ [paper](https://sites.bu.edu/lejeunelab/files/2021/02/Transfer_Learning.pdf) | [code](https://github.com/Lejeune-Lab/Mechanical-MNIST-Transfer-Learning) | [data](https://open.bu.edu/handle/2144/41357) \]
* Lejeune, E. (2021). Geometric stability classification: datasets, metamodels, and adversarial attacks. Computer-Aided Design, 131, 102948. \[ [paper](https://sites.bu.edu/lejeunelab/files/2021/02/BIC.pdf) | [code](https://github.com/Lejeune-Lab/BIC) | [data](https://open.bu.edu/handle/2144/40085) \]
* Kakaletsis, S., Meador, W. D., Mathur, M., Sugerman, G. P., Jazwiec, T., Malinowski, M., Lejeune, E., Timek, T.A., & Rausch, M. K. (2020). Right Ventricular Myocardial Mechanics: Multi-Modal Deformation, Microstructure, Modeling, and Comparison to the Left Ventricle. Acta Biomaterialia. \[ [paper](https://sites.bu.edu/lejeunelab/files/2021/02/RV_Mechanics.pdf) | [data](https://dataverse.tdl.org/dataverse/RVMechanics) \]
* Lejeune, E. (2020). Mechanical MNIST: A benchmark dataset for mechanical metamodels. Extreme Mechanics Letters, 100659. \[ [paper](https://sites.bu.edu/lejeunelab/files/2020/08/Mechanical_MNIST.pdf) | [code](https://github.com/Lejeune-Lab/Mechanical-MNIST) | [data](https://open.bu.edu/handle/2144/39371) \]
